...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://formspree.io/f/xdkdebpz', formData);
      setStatus({ 
  ...
  return (
    <section
      ...
      style={{
        background: `
          linear-gradient(90deg, rgba(0,100,0,0.95) 0%, rgba(50,0,0,0.95) 100%),
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white dark:text-[#64FFDA]">
            Let's Connect
          </h2>
          <div className="w-20 h-1 bg-gradient-to-r from-[#64FFDA] to-[#0A192F] mx-auto mb-4 rounded"></div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div
            className="bg-white/90 dark:bg-[#222222]/90 rounded-xl shadow-lg p-8"
            data-aos="fade-right"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white text-[#0A192F]
                               focus:outline-none focus:ring-2 focus:ring-[#64FFDA] focus:border-transparent
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="block w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white text-[#0A192F]
                             focus:outline-none focus:ring-2 focus:ring-[#64FFDA] focus:border-transparent
                             transition-shadow duration-500 ease-in-out"
              ...
              <button
                ...
                className="w-full flex justify-center items-center px-6 py-3 border border-transparent rounded-lg shadow-sm text-base font-medium text-white
                           bg-gradient-to-r from-[#0A192F] to-[#64FFDA]
                           hover:from-[#64FFDA] hover:to-[#0A192F]
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-lg font-medium text-[#0A192F] dark:text-white hover:text-[#64FFDA] transition-colors duration-500 ease-in-out"
                  >
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="p-3 bg-gray-100 dark:bg-gray-300 rounded-lg hover:bg-gradient-to-r hover:from-[#64FFDA] hover:to-[#0A192F] hover:text-[#0A192F] transition-colors duration-500 ease-in-out"
                  >
